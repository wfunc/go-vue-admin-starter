...
func (_q *SystemConfigQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SystemConfigQuery) FirstIDX(ctx context.Context) int {
...
func (_q *SystemConfigQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SystemConfigQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *SystemConfigQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *SystemConfigQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
